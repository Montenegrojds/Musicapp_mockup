    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home_principal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent numbersIntent = new Intent(Search.this, MainActivity.class);
        ...
        buscar_canciones.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent numbersIntent = new Intent(Search.this, Search.class);
                startActivity(numbersIntent);
            }
        });
        ...
        cancionesFavoritas.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent numbersIntent = new Intent(Search.this, Favorites.class);
                startActivity(numbersIntent);
            }
        });
        ...
        listaDeMusica.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent numbersIntent = new Intent(Search.this, List.class);
                startActivity(numbersIntent);
            }
        });
